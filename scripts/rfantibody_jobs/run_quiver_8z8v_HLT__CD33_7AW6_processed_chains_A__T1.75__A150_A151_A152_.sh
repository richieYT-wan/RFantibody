...
# threshold: 1.75
# start:     A148
mkdir -p $(dirname ./scripts/rfantibody_jobs/logs/quiver_8z8v_HLT__CD33_7AW6_processed_chains_A__T1.75__A150_A151_A152_.log)
touch ./scripts/rfantibody_jobs/logs/quiver_8z8v_HLT__CD33_7AW6_processed_chains_A__T1.75__A150_A151_A152_.log
nohup bash "$ROOTDIR/scripts/pipeline_rfantibody.sh" \
  ...
  > "./scripts/rfantibody_jobs/logs/quiver_8z8v_HLT__CD33_7AW6_processed_chains_A__T1.75__A150_A151_A152_.log" 2>&1
